...
Solution Script: `num_days_lab.py`

## 4.3.1.8 LAB - Day of the year
...
Solution Script: `day_year_lab.py`

## 4.3.1.9 LAB - Prime numbers
...
Solution Script: `prime_num_lab.py`
...
Solution Script: `convert_fuel_consumption_lab.py`
...
Solution Script: `tic_tac_toe_lab.py`